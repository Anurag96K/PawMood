          ...
          return (
            ...
            >
              ...
              <div className="w-7 h-7 flex items-center justify-center relative">
                ...
                {/* iOS-style notification badge - RED color (#FF3B30) with Pill Support */}
                {hasBadge && (() => {
                  const isTwoDigit = tab.badge! >= 10;
                  const displayCount = tab.badge! > 99 ? "+99" : tab.badge;
                  return (
                    <span
                      className={cn(
                        "absolute -top-1 -right-1.5 h-[18px] flex items-center justify-center animate-scale-in shadow-sm border-[1.5px] border-white z-20 rounded-full",
                        isTwoDigit ? "px-1.5 min-w-[24px]" : "w-[18px]"
                      )}
