...
export function ExtraCreditsModal({
    ...
    const handlePurchase = () => {
        ...
        if (pkg) {
            ...
            console.log("Purchased package:", selectedPackage, "credits:", pkg.credits);
        }
            ...
            {isOpen && (
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-[320px] bg-card rounded-xl border border-border/50 overflow-hidden"
                        style={{
                            ...
                            <div className="grid grid-cols-3 gap-2">
                                {creditPackages.map((pkg) => (
                                    <button
                                        ...
                                        className={`relative flex flex-col items-center py-3 px-2 rounded-xl border-2 transition-all ${selectedPackage === pkg.id
